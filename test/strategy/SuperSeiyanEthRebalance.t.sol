...
import {
    SuperSeiyanEthRebalanceDecoderAndSanitizer,
    BaseDecoderAndSanitizer,
    NativeWrapperDecoderAndSanitizer,
    ERC4626DecoderAndSanitizer,
    CurveDecoderAndSanitizer,
    LidoDecoderAndSanitizer
} from "src/base/DecodersAndSanitizers/SuperSeiyanEthRebalanceDecoderAndSanitizer.sol";
...
uint256 constant ACCEPTED_CURVE_RECEIVE_wstETH_4_pufETH = 37809434366405849110;
uint256 constant ACCEPTED_CURVE_RECEIVE_pxETH_4_stETH = 127995727902421840267;
uint256 constant ACCEPTED_CURVE_RECEIVE_pxETH_4_WETH = 212.190180004786920437e18;
uint256 constant ACCEPTED_CURVE_RECEIVE_frxETH_4_WETH = 134769063329213309637;

uint256 constant _0_ETH = 180307860000000000000;
uint256 constant _1_pufETH = 44270212023406936460;
uint256 constant _2_pufETH = _1_pufETH;

uint256 constant _3_wstETH = 108340531507543909110;
uint256 constant _4_stETH =  127929409479523956592;
uint256 constant _5_stETH = _4_stETH;

uint256 constant _6_WETH = 2.12051504005294e20;
uint256 constant _7_WETH = _6_WETH;
uint256 constant _8_pxETH = 212.190180004786920437e18 + 127995727972421840266;
uint256 constant _9_pxETH = _8_pxETH;

uint256 constant _10_WETH = 134437881624271418580;
uint256 constant _11_WETH = _10_WETH;
uint256 constant _12_frxETH = 134769063329213309637;
uint256 constant _13_frxETH = _12_frxETH;
...
contract SeiyanEthRebalanceStrategyTest is StrategyBase {
    ...
    SuperSeiyanEthRebalanceDecoderAndSanitizer decoder;
    ...
    // DEPLOY: replace with real decoder sanitizer
    function setUpDecoderSanitizers() public override {
        decoder = SuperSeiyanEthRebalanceDecoderAndSanitizer(0xa01E94F7bE85Adf2c9f2F32caD9200a69CFB75BA);
    }
    ...
    function testRebalance() public {
        ...
        vm.startPrank(ADMIN);
        // DEPLOY: set real root and remove this
    ...
    function step1(Leaf[] memory myLeafs) internal {
        ...
        int128 _j = 1; // index of coin to receleaf
            abi.encodeWithSelector(myLeafs[2].selector, _i, _j, _2_pufETH, ACCEPTED_CURVE_RECEIVE_wstETH_4_pufETH);
        values[i] = 0;
