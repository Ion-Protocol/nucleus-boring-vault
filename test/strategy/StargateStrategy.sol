...
address constant MANAGER = 0x9B99d4584a3858C639F94fE055DB9E94017fE009;

address constant seiyanETHDecoderAndSanitizer = 0x660F2E0710757636AeB56b0c013522c71f33373a;
address constant ssETHDecoderAndSanitizer = 0xF333b575a1Ce56C88E4C7B7fe9F5ad16bDA50852;
...
contract StargateStrategy is StrategyBase {
    ...
    SuperSeiyanEthRebalanceDecoderAndSanitizer sanitizer;
    ...
    function setUp() public override {
        ...
        boringVault = (ManagerWithMerkleVerification(MANAGER).vault());
        super.setUp();
    }

    function setUpDecoderSanitizers() public override {
        // DEPLOY: replace with real sanitizer
        sanitizer = SuperSeiyanEthRebalanceDecoderAndSanitizer(seiyanETHDecoderAndSanitizer);
        // sanitizer = new SuperSeiyanEthRebalanceDecoderAndSanitizer(address(boringVault));
    }
    ...
    function testSend() external {
        ...
        uint256 valueToSend = mf.nativeFee * 1.1 ether / 1 ether;
        mf.nativeFee = valueToSend;
