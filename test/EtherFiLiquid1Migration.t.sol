...
// import { EtherFiLiquidDecoderAndSanitizer } from
// "src/base/DecodersAndSanitizers/EtherFiLiquidDecoderAndSanitizer.sol";
...
//                 if (leaf == tree[i][j]) {
//                     // We have found the leaf, so now figure out if the proof needs the next leaf or the previous
// one.
