...
contract WithdrawQueueFuzzingTest is WithdrawQueueIntegrationBaseTest {

    function testFuzz_QueuePathsWithExchangeRateChanges(uint96 r0, uint96 r1, uint96 r2) external {
