...
import { CrossChainTellerBasePredicate, BridgeData } from "./CrossChainTellerBasePredicate.sol";
...
/**
 * @title MultiChainTellerBasePredicate
 ...
 */
abstract contract MultiChainTellerBasePredicate is CrossChainTellerBasePredicate {
    event ChainAdded(
    ...
    constructor(
        ...
        CrossChainTellerBasePredicate(_owner, _vault, _accountant, _serviceManager, _policyID)
    { }
