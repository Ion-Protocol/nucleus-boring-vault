...
/**
 * @title CrossChainTellerBasePredicate
 * @notice Base contract for the CrossChainTeller, includes functions to overload with specific bridge method
 */
abstract contract CrossChainTellerBasePredicate is TellerWithMultiAssetSupportPredicate {
    ...
    constructor(
        ...
        TellerWithMultiAssetSupportPredicate(_owner, _vault, _accountant, _serviceManager, _policyID)
    { }
